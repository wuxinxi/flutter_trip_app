...
const CATCH_URLS=['m.ctrip.com/','m.ctrip.com/html5/','m.ctrip.com/webapp/you/'];
...
class _WebViewState extends State<WebView>{
  ...
  Widget build(BuildContext context) {
    ...
    Color btnColor=statusBarColorStr=='ffffff'?Colors.black:Colors.white;
      ...
      child:FractionallySizedBox(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
              child: Center(
                child: Text(widget.title,style:TextStyle(color: bgColor,fontSize: 18.0)),
              ),
              left: 0,
              right: 0,
            )
